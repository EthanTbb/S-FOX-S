...
//支持规则
#define SR_SUPORT_TYPE_PC			0x01000000							//支持PC
#define SR_SUPORT_TYPE_MOBILE		0x02000000							//支持手机
...
public:
	//支持手机
	static bool IsSuportMobile(DWORD dwServerRule) { return (dwServerRule&SR_SUPORT_TYPE_MOBILE)!=0; }
	//支持PC
	static bool IsSuportPC(DWORD dwServerRule) { return (dwServerRule&SR_SUPORT_TYPE_PC)!=0; }
	//支持手机
	static VOID SetSuportMobile(DWORD& dwServerRule, bool bEnable) {  (bEnable==true)?dwServerRule|=SR_SUPORT_TYPE_MOBILE:dwServerRule&=~SR_SUPORT_TYPE_MOBILE; }
	//支持PC
	static VOID SetSuportPC(DWORD& dwServerRule, bool bEnable) {  (bEnable==true)?dwServerRule|=SR_SUPORT_TYPE_PC:dwServerRule&=~SR_SUPORT_TYPE_PC; }
