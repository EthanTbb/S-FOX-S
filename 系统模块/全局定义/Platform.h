...
//地址定义
const TCHAR szCookieUrl[]=TEXT("http://47.92.84.61");					//记录地址
const TCHAR szLogonServer[]=TEXT("47.92.84.61");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://47.92.84.61");				//平台网站
