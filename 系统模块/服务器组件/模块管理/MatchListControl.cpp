...
LPCTSTR CRewardListControl::GetDescribeString(tagMatchRewardInfo * pMatchRewardInfo, WORD wColumnIndex)
{
	...
	case 1:		//金币奖励
		{
			_sntprintf(szDescribe,CountArray(szDescribe),TEXT("%I64d"),pMatchRewardInfo->lRewardGold);

			return szDescribe;
		}
	case 2:		//元宝奖励
		{
			_sntprintf(szDescribe,CountArray(szDescribe),TEXT("%I64d"),pMatchRewardInfo->lRewardIngot);
