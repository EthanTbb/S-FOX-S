...
bool CDlgServerItem::OpenGameServer(WORD wServerID)
{
	...
	tagPersonalRoomOptionRightAndFee  personalRoomOptionRightAndFee;
	memset(&personalRoomOptionRightAndFee, 0, sizeof(tagPersonalRoomOptionRightAndFee));

	if (GameServerResult.wServerType == GAME_GENRE_PERSONAL)
	{
		ServerInfoManager.LoadPersonalRoomParameter(personalRoomOption,  personalRoomOptionRightAndFee, GameServerResult.wKindID);
	}
...
bool CDlgServerItem::LoadPersonalRoomPatameter(WORD wServerID)
{
	...
	ServerInfoManager.LoadPersonalRoomParameter(personalRoomOption,  PersonalRoomOptionRightAndFee, wServerID);
