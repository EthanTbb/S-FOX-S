...
//颜色定义
#define CR_BACK_FRAME				RGB(189,173,139)					//背景颜色
#define CR_BACK_FACE				RGB(255,255,255)					//背景颜色
...
VOID CFaceItemSelectWnd::DrawFaceItem(CDC * pDC, WORD wIndex, INT nXPos, INT nYPos, bool bHover)
{
	...
	pBufferDC->FillSolidRect(FRAME_WIDTH/2,FRAME_HEIGHT/2,FACE_CX,FACE_CY,CR_BACK_FACE);
