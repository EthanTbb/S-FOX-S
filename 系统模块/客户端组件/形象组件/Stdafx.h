...
#pragma comment(lib,"VFW32.lib")
	...
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/FGuilib.lib")
	...
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/FGuimfcFactory.lib")
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/PlatformData.lib")
#else
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/WHImage.lib")
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/FGuilib.lib")
	...
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/FGuimfcFactory.lib")	
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/PlatformData.lib")
#endif
#else
#ifndef _UNICODE
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/WHImageD.lib")
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/FGuilibD.lib")
	...
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/FGuimfcFactoryD.lib")	
	#pragma comment (lib,"../../Á´½Ó¿â/Ansi/PlatformDataD.lib")
#else
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/WHImageD.lib")
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/FGuilibD.lib")
	...
	#pragma comment (lib,"../../Á´½Ó¿â/Unicode/FGuimfcFactoryD.lib")	
