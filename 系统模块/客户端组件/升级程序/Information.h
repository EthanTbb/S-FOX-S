...
//全局函数
extern "C" CLIENT_CONTROLS_CLASS INT __cdecl ShowInformation(LPCTSTR pszString, UINT uType=MB_OK, UINT nElapse=0, CWnd *pParentWnd=NULL);
extern "C" CLIENT_CONTROLS_CLASS INT __cdecl ShowInformationEx(LPCTSTR pszCaption, LPCTSTR pszString, UINT uType=MB_OK, UINT nElapse=0, CWnd *pParentWnd=NULL);
