...
public:
	//机器用户
	virtual bool IsAndroidUser() { return m_bIsAndroid; }
...
public:
	//用户元宝
	virtual SCORE GetUserIngot() { return m_UserInfo.lIngot; }
	//积分数值
...
protected:
	...
	static WORD						m_wObjectRefCount;					//对象计数
...
public:
	...
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo,tagCustomFaceInfo & CustomFaceInfo,bool bIsAndroid);

	//更新接口
public:
	//更新积分
	virtual bool UpdateUserItemScore(IClientUserItem * pIClientUserItem, tagUserScore * pUserScore);
	//更新状态
	virtual bool UpdateUserItemStatus(IClientUserItem * pIClientUserItem, tagUserStatus * pUserStatus);
	//更新属性
	virtual bool UpdateUserItemAttrib(IClientUserItem * pIClientUserItem, tagUserAttrib * pUserAttrib);
	//更新头像
...
public:
	//获得人数
	virtual DWORD GetActiveUserCount(){return (DWORD)m_UserItemActive.GetCount();}
};
...
public:
	...
	virtual bool DeleteUserItem(IClientUserItem * pIClientUserItem);
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo,tagCustomFaceInfo & CustomFaceInfo, BYTE cbCompanion, LPCTSTR pszUserNote,bool bIsAndroid);
