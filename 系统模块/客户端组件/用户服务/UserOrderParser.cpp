...
CUserOrderParser::CUserOrderParser()
{
	...
	//默认设置
	m_MapMemberDescribe[1]=TEXT("VIP1会员");
	m_MapMemberDescribe[2]=TEXT("VIP2会员");
	m_MapMemberDescribe[3]=TEXT("VIP3会员");
	m_MapMemberDescribe[4]=TEXT("VIP4会员");
	m_MapMemberDescribe[5]=TEXT("VIP5会员");
