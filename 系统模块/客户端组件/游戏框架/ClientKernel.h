...
//内核框架
class CClientKernel : public CWnd, public IClientKernel, public IProcessControlSink, public IUserManagerSink, public IClientCompilationSink
{
	//状态变量
protected:
...
protected:
	...
	IClientPropertySink *		    m_pIClientPropertySink;             //道具接口 
...
public:
	...
	//设置接口
	virtual bool SetClientPropertySink(IUnknownEx * pIUnknownEx);
	//游戏属性
...
public:
	...
	//查找用户
	virtual IClientUserItem * SearchUserByNickName(LPCTSTR szNickName);
	//旁观用户
...
public:
	//信息接口
	virtual IStringMessage * GetIStringMessage(){return m_pIStringMessage;}
	//设置事件
...
protected:
	...
	//道具消息
	bool OnProcessMainPropertyInfo(WORD wSubCmdID, VOID * pData, WORD wDataSize);
