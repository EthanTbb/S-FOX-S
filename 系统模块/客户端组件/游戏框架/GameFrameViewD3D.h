...
public:
	...
	//绘画头像
	VOID DrawUserAvatar(CD3DDevice * pD3DDevice, INT nXPos, INT nYPos, INT nWidth, INT nHeight, IClientUserItem * pIClientUserItem);
...
public:
	...
	//比赛信息
	VOID DrawMatchInfo(CD3DDevice * pD3DDevice);
