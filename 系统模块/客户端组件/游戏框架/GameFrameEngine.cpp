...
bool CGameFrameEngine::CreateGameFrameEngine()
{
	...
	m_ClientCompilationSink=(IClientCompilationSink *)pGlobalUnits->QueryGlobalModule(MODULE_CLIENT_KERNEL,IID_IClientCompilationSink,VER_IClientCompilationSink);
