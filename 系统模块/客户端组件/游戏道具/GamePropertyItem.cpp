...
CGamePropertyCar::CGamePropertyCar()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有汽车刹车的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyEgg::CGamePropertyEgg()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有扔臭蛋的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyClap::CGamePropertyClap()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有拍手动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyKiss::CGamePropertyKiss()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有吻的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyBeer::CGamePropertyBeer()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有喝啤酒的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyCake::CGamePropertyCake()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有手捧蛋糕献上的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyRing::CGamePropertyRing()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有钻戒闪耀的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyBeat::CGamePropertyBeat()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有一人物被暴打的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyBomb::CGamePropertyBomb()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有炸弹爆炸的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertySmoke::CGamePropertySmoke()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有抽烟的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyVilla::CGamePropertyVilla()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在游戏界面中间，有房子出现的动画声效"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyBrick::CGamePropertyBrick()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在获赠者屏幕上，有板砖砸裂的动画声效。"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyFlower::CGamePropertyFlower()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("出现在获赠者屏幕上，有手持鲜花的动画声效。"),CountArray(m_PropertyAttrib.szRegulationsInfo));
...
CGamePropertyBlueRingCard::CGamePropertyBlueRingCard()
{
	...
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("会员购买道具礼物时可享受折扣优惠，可踢普通玩家，有蓝钻会员特殊标志，会员期间，名字ID在用户列表中以红色字体突出显示，并可优先进入满员房间！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
CGamePropertyCrystal::CGamePropertyCrystal()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("个"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("水晶"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具的用户，可以立即获得一定数量金币！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyCrystal::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的水晶，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
CGamePropertyAgate::CGamePropertyAgate()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("个"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("玛瑙"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具的用户，可以立即获得一定数量金币！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyAgate::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	if(szSourceNickName==szTargerNickName)
		...
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玛瑙，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
CGamePropertyBoulder::CGamePropertyBoulder()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("个"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("玉石"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具的用户，可以立即获得一定数量金币！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyBoulder::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，玉石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的玉石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
CGamePropertyGem::CGamePropertyGem()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("个"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("宝石"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具的用户，可以立即获得一定数量金币！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyGem::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，宝石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的宝石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
CGamePropertyDiamond::CGamePropertyDiamond()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("个"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("钻石"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具的用户，可以立即获得一定数量金币！"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyDiamond::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具使用成功，钻石，恭喜您获得%d游戏币！"),wItemCount*m_PropertyItem.lUseResultsGold);
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您的钻石，使用后将获得%d游戏币！"),szSourceNickName,wItemCount*m_PropertyItem.lUseResultsGold);
...
CGamePropertyDouble1Hour::CGamePropertyDouble1Hour()
{
	...
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("小时"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("双倍积分卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("拥有双倍积分卡，游戏赢分将获得双倍积分，输分不多扣！（此道具在游戏房间生效。）"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyDouble1Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1小时内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1小时内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
CGamePropertyDouble3Hour::CGamePropertyDouble3Hour()
{
	...
	m_PropertyAttrib.wPropertyType=PT_TYPE_PROPERTY;
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER|PT_SERVICE_AREA_LOOKON;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("3小时"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("双倍积分卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("拥有双倍积分卡，游戏赢分将获得双倍积分，输分不多扣！（此道具在游戏房间生效。）"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyDouble3Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，3小时内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。3小时内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
CGamePropertyDouble1Day::CGamePropertyDouble1Day()
{
	...
	m_PropertyAttrib.wPropertyType=PT_TYPE_PROPERTY;
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER|PT_SERVICE_AREA_LOOKON;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("天"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("双倍积分卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("拥有双倍积分卡，游戏赢分将获得双倍积分，输分不多扣！（此道具在游戏房间生效。）"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyDouble1Day::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1天内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1天内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
CGamePropertyDouble1Week::CGamePropertyDouble1Week()
{
	...
	m_PropertyAttrib.wPropertyType=PT_TYPE_PROPERTY;
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER|PT_SERVICE_AREA_LOOKON;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("周"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("双倍积分卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("拥有双倍积分卡，游戏赢分将获得双倍积分，输分不多扣！（此道具在游戏房间生效。）"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyDouble1Week::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，双倍积分卡即时生效，1周内您游戏赢分将获得双倍积分，输分不多扣。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您双倍积分卡道具，即时生效。1周内您游戏赢分将获得双倍积分，\n输分不多扣。"),szSourceNickName);
...
CGamePropertyAmulet1Hour::CGamePropertyAmulet1Hour()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("小时"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("护身卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具后,您游戏输分不扣分,赢分正常得分,不再为扣分而烦恼! (此道具卡只能在积分房间购买,且仅在购买的游戏房间生效. )"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyAmulet1Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	...
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1小时内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1小时内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet3Hour::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，3小时内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。3小时内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
CGamePropertyAmulet1Day::CGamePropertyAmulet1Day()
{
	...
	m_PropertyAttrib.wServiceArea=PT_SERVICE_AREA_MESELF|PT_SERVICE_AREA_PLAYER|PT_SERVICE_AREA_LOOKON;
	lstrcpyn(m_PropertyAttrib.szMeasuringunit,TEXT("天"),CountArray(m_PropertyAttrib.szMeasuringunit));
	lstrcpyn(m_PropertyAttrib.szPropertyName,TEXT("防身卡"),CountArray(m_PropertyAttrib.szPropertyName));
	lstrcpyn(m_PropertyAttrib.szRegulationsInfo,TEXT("购买该道具后,您游戏输分不扣分,赢分正常得分,不再为扣分而烦恼! (此道具卡只能在积分房间购买,且仅在购买的游戏房间生效. )"),CountArray(m_PropertyAttrib.szRegulationsInfo));
}
...
LPCTSTR CGamePropertyAmulet1Day::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1天内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1天内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
...
LPCTSTR CGamePropertyAmulet1Week::GetNotifyMessage(LPCTSTR szSourceNickName,LPCTSTR szTargerNickName,WORD wItemCount,LPTSTR szResultMessage)
{
	TCHAR szMessage[128]=TEXT("");
	if(szSourceNickName==szTargerNickName)
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！道具购买成功，护身卡即时生效，1周内您游戏输分不扣分，赢分正常得分。"));
	else
		_sntprintf(szMessage,CountArray(szMessage),TEXT("恭喜您！[ %s ]玩家赠送了您护身卡道具，即时生效。1周内您游戏输分不扣分，赢分正常得分。"),szSourceNickName);
