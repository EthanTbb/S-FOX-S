...
public:
	...
	//桌子状态 
	virtual VOID SetTableStatus(bool bPlaying, bool bLocker,LONG lCellScore)=NULL;
...
public:
	...
	//桌子状态 
	virtual VOID SetTableStatus(bool bWaitDistribute)=NULL;
	//桌子状态 
	virtual VOID SetTableStatus(WORD wTableID, bool bPlaying, bool bLocker,LONG lCellScor)=NULL;
