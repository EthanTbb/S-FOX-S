#ifndef INSURE_COMMON_HEAD_FILE
#define INSURE_COMMON_HEAD_FILE
...
// 				wcsncat(szResult, _szNum[0], SZ_LEN);
// 			nIndex += nPartLen;
// 			uEmptyBigUnitCount++;
// 			continue;
// 		}
...
// 					wcsncat(szResult, _szNum[0], SZ_LEN);
// 				wcsncat(szResult, _szNum[uNum], SZ_LEN);
// 				if (nPartLen - i - 2 >= 0)
// 					wcsncat(szResult, szSmallUnits[nPartLen - i - 2], SZ_LEN);
// 				bFillZero = false;
// 			}
// 		}
// 
...
// 				wcsncat(szResult, szBigUnits[(nLen - nIndex) / 4 - 2], SZ_LEN);
// 		}
// 		else
// 		{
// 			if ((nLen - nIndex) / 4 - 1 >= 0)
// 				wcsncat(szResult, szBigUnits[(nLen - nIndex) / 4 - 1], SZ_LEN);
// 		}
// 
