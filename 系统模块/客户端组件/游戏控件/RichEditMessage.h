...
#define COLOR_NORMAL				RGB(255,255,255)					//普通消息
#define COLOR_SYSTEM_STRING			RGB(255,255,255)					//系统消息
...
protected:
	...
	CDataObject                     m_ImageDataTrumpet;                 //资源变量
	CDataObject                     m_ImageDataTyphon;                  //资源变量 
...
public:
	//普通消息
	bool InsertNormalString(LPCTSTR pszString,COLORREF crColor);
	//系统消息
	bool InsertSystemString(LPCTSTR pszString,COLORREF crColor);
	//提示消息
	bool InsertPromptString(LPCTSTR pszString,COLORREF crColor);
	//公告消息
	bool InsertAfficheString(LPCTSTR pszString,COLORREF crColor);
