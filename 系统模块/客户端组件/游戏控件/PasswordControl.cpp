...
VOID CPasswordControl::PreSubclassWindow()
{
	...
	m_edPassword.SetDisableColor(RGB(125,125,125),RGB(255,255,255),RGB(255,255,255));
...
VOID CPasswordControl::OnPaint()
{
	...
	{
		dc.FillSolidRect(rcClient,m_edPassword.m_crEnableBK/* CSkinEdit::m_SkinAttribute.m_crEnableBK*/);
	}
	else
	{
