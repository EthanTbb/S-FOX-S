...
class FGUI_LIB_CLASS CListExUI : public CListUI
{
public:
	...
	bool InnerExpandCollapse(CNodeElementUI* pNodeElementUI,bool InnerState);
	bool ExpandItem(CNodeElementUI* pNodeElementUI);
	bool CollapseItem(CNodeElementUI* pNodeElementUI);

	void SetAuotoCollapse(bool bAuotoCollapse);
	bool IsAuotoCollapse();

private:
	CStdNode* _root;
	CNodeElementUI* _RootElement;
	bool m_bAuotoCollapse;
