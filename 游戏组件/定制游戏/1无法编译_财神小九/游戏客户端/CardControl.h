...
protected:
	...
	//资源变量
public:
	CD3DTexture	static				m_TexCard;						//图片资源
protected:
	CSize							m_CardSize;							//扑克大小	
	CD3DTexture				        m_TexOpenCardHandle;				//图片资源  IDB_HAND
	DWORD							m_dwDragMax;						//拖牌最远距离
	DWORD							m_dwCurrentIndex;
	//CD3DTexture						m_TexCardSelect;
...
public:
	//加载资源
	void LoadGameResource(CD3DDevice * pD3DDevice, INT nWidth, INT nHeight);
