...
#ifndef _DEBUG
	#define LOG4CFFILE TEXT("Thirteen\\log4c_release.log")
#else
	#define LOG4CFFILE TEXT("Thirteen\\log4c_debug.log")
#endif

#define OUTPUT_LOG4C(x) CLog4CFile::WriteLog(LOG4CFFILE, x)
//////////////////////////////////////////////////////////////////////////
