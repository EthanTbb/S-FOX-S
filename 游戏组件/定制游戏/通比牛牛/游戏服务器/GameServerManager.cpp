...
//////////////////////////////////////////////////////////////////////////
//机器定义
#define ANDROID_SERVICE_DLL_NAME  TEXT("OxSixAndroid.dll")  //组件名字
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("OxSixEx.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("OxSixExServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
  ...
  {
    GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*2L,GameServiceOption.lMinTableScore);
  }
