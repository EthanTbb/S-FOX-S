...
struct tagCardItem
{
  ...
  tagCardItem(tagCardItem& tRight)
  {
    this->bShoot = tRight.bShoot;
    this->bShowCard = tRight.bShowCard;
    this->bCardData = tRight.bCardData;
  }
};
...
public:
  ...
  //设置扑克
  DWORD SetCardData(const BYTE bCardData[], DWORD dwCardCount, bool bShow=true);
  //获取扑克
