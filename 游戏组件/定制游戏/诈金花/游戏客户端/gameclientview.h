...
#define IDM_GAME_SOUND        WM_USER+115             //游戏设置
#define IDM_GAME_CLOSE        WM_USER+116             //游戏关闭
#define WM_SET_CAPTION        WM_USER+117             //更改标题
...
protected:
  ...
  bool              m_bShowControlBack;         //控件背景
  bool              m_bShowChatMessage;         //
  INT               m_nHeight;              //窗口高度
  INT               m_nWidth;             //窗口宽度
  bool              m_bChangSence;            //场景切换
  bool              m_bCloseEye[GAME_PLAYER];     //眨眼状态
  BYTE              m_cbWink[GAME_PLAYER];        //连眨间隔
  BYTE              m_cbUserIndex[GAME_PLAYER];     //人物索引
...
protected:
  ...
  CPoint              m_ptPlayerFrame[GAME_PLAYER];   //玩家框架
  CPoint              m_ptUser[GAME_PLAYER];        //人物位置
...
public:
  ...
  CSkinButton           m_btJetton_1;           //加注按钮
  CSkinButton           m_btJetton_2;           //加注按钮
  CSkinButton           m_btJetton_5;           //加注按钮
...
protected:
  ...
  CPngImage           m_ImageComPareCard;         //扑克资源
  ...
  CPngImage           m_PngImageViewBack_1;       //背景资源
  CPngImage           m_PngImageViewBack_2;       //背景资源
  CPngImage           m_PngImageTable;          //桌子资源
  CPngImage           m_PngImagePlayerFrame;        //玩家框架
  CPngImage           m_PngImageJetonBack;        //按钮背景
  CPngImage           m_PngImageFrameBack;        //框架背景
  CPngImage           m_PngFengding;            //封顶框
  CPngImage           m_PngImageFrameBackBottom;      //

  CPngImage           m_PngImageTimeBack;         //时间背景
  CPngImage           m_PngImageTimeNumber;       //时间数字
  CPngImage           m_PngaImageXZNumber;        //下注数字
  CPngImage           m_PngImageFDNumber;         //封顶数字
  CPngImage           m_PngImageChatBack;         //聊天背景
  CPngImage           m_PngImageMyself;         //金币数字
  CPngImage           m_PngImageArrow;          //箭头资源
  CPngImage           m_PngSelectPlayer;          //选择比牌
  CPngImage           m_PngWaitSelect;          //等待比牌
  ...
  CPngImageEx           m_ImageUser[GAME_PLAYER];     // 人物图片
  CPngImageEx           m_ImageEye[GAME_PLAYER];      // 人物图片
