...
protected:
  ...
  static CSize          m_SmallCardSize;          //扑克大小
  static CPngImage        m_ImageCard;            //图片资源
  static CPngImage        m_ImageSmallCard;         //图片资源
  static CPngImage        m_PngCardType;            //牌型
  static CPngImage        m_PngStatus;            //状态资源
...
public:
  ...
  //牌型
  void SetCardType(BYTE bCardType)
  {
    m_bCardType=bCardType;
  };
  //设置小牌型
  void SetSmallCard(bool bSmall)
  {
    m_bSmall = bSmall;
  }
  //设置小牌型
