...
#define SUB_S_TRUE_END				106									//结束消息
...
struct CMD_S_StatusFree
{
	...
	//机器人信息
	LONGLONG						lRobotScoreMin;					// 积分低于取款
	LONGLONG						lRobotScoreMax;					// 积分高于存款
	LONGLONG						lRobotBankTake[2];				// 取款额度
	LONGLONG						lRobotBankSave;					// 存款额度
};
...
struct CMD_S_GameStart
{
	...
	BYTE							cbHandCardData[GAME_PLAYER][5];		//用户扑克
};
...
#define SUB_C_ADD_SCORE_TIME		4									//完成动画
