...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("OxExAndroid.dll") //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("OxExAndroid.dll") //组件名字
#endif
...
CGameServiceManager::CGameServiceManager(void)
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("OxEx.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("OxExServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::DefaultCustomRule(LPBYTE pcbCustomRule, WORD wCustonSize)
{
  ...
  //设置变量
  pCustomRule->lFirstRange0 = 0;
  pCustomRule->lFirstRange1 = 50000;
  pCustomRule->lSecondRange0 = 50000;
  pCustomRule->lSecondRange1 = 100000;
  pCustomRule->lThirdRange0 = 100000;

  //机器人赢分几率
  pCustomRule->cbRobotRadio1 = 30;
  pCustomRule->cbRobotRadio2 = 50;
  pCustomRule->cbRobotRadio3 = 80;
