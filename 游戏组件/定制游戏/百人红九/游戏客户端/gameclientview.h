...
#define IDM_GAME_OPTIONS      WM_USER+206             //游戏设置消息
#define IDM_GAME_SOUND        WM_USER+207             //游戏声音
...
#define NORMAL_MAX_FALG_COUNT       15              //正常模式标识个数          
...
public:
  ...
  CSkinButton           m_btUp;               //庄家列表按钮
  CSkinButton           m_btDown;             //庄家列表按钮
...
protected:
  ...
  CPngImageEx           m_ImageJettonView;          //筹码视图
  CPngImageEx           m_ImageScoreNumber;         //数字视图
  CPngImageEx           m_ImageMeScoreNumber;       //数字视图
  ...
  //边框资源
protected:
  CPngImageEx           m_ImageFrameShunMen;        //边框图片
  CPngImageEx           m_ImageFrameJiaoL;          //边框图片
  CPngImageEx           m_ImageFrameQiao;         //边框图片
  CPngImageEx           m_ImageFrameDuiMen;         //边框图片
  CPngImageEx           m_ImageFrameDaoMen;         //边框图片
  CPngImageEx           m_ImageFrameJiaoR;          //边框图片
  ...
  //结束资源
protected:
  CPngImageEx           m_ImageGameEnd;           //成绩图片
