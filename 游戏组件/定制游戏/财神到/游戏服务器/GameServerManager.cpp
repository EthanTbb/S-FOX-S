...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("GodInAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("GodInAndroid.dll")	//组件名字
#endif
...
CGameServiceManager::CGameServiceManager(VOID)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("GodIn.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("GodInServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
