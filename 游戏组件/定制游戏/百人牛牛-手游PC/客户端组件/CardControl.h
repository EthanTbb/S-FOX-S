...
#define DEF_SHOOT_DISTANCE			25									//默认间距

//间距定义
#define DEF_X_DISTANCE_SMALL		17									//默认间距
#define DEF_Y_DISTANCE_SMALL		17									//默认间距
#define DEF_SHOOT_DISTANCE_SMALL	25									//默认间距
...
protected:
	...
	CPngImage	static				m_ImageCard;						//图片资源
	CPngImage						m_ImageOpenCardHandle;				//图片资源  IDB_HAND
