...
void CGameRecord::FillGameRecourd(tagGameRecord & GameRecord)
{
	...
	//游戏局数
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%d"),GameRecord.wDrawCount);
	...
	//本局成绩
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.lGameScore);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//本局下注
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.lMyAddGold);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//闲家下注
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.lDrawPlayerScore);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//平家下注
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.lDrawTieScore);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//庄家下注
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.lDrawBankerScore);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//闲家牌点
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.cbPlayerPoint);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);

	//庄家牌点
	_sntprintf(szBuffer,CountArray(szBuffer),TEXT("%I64d"),GameRecord.cbBankerPoint);
	m_RecordGameList.SetItem(nItemIndex,wColumnCount++,LVIF_TEXT,szBuffer,0,0,0,0);
