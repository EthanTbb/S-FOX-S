				...
				case CS_BET_AREA:
					{
						...
						for(cbIndex=0;cbIndex<AREA_COUNT;cbIndex++)
						{
							if(m_bWinArea[cbIndex])
							{
								...
								switch(cbIndex)
								{
								case 0:str+=TEXT("东 ");break;
								case 1:str+=TEXT("南 ");break;
								case 2:str+=TEXT("西 ");break;
								case 3:str+=TEXT("北 ");break;
								default: break;
								}
							}
						}
...
BOOL CClientControlItemSinkDlg::OnInitDialog()
{
	...
	m_listUserBet.InsertColumn(nColumnCount++,TEXT("东"),LVCFMT_CENTER,70);
	m_listUserBet.InsertColumn(nColumnCount++,TEXT("南"),LVCFMT_CENTER,70);
	m_listUserBet.InsertColumn(nColumnCount++,TEXT("西"),LVCFMT_CENTER,70);
	m_listUserBet.InsertColumn(nColumnCount++,TEXT("北"),LVCFMT_CENTER,70);
