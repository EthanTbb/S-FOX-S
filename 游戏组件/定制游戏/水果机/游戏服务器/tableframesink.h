...
#define MAX_STORAGE_COUNT			 2									//库存封顶等级
//////////////////////////////////////////////////////////////////////////
...
protected:
	...
	LONGLONG						m_lUserTotalScore[GAME_PLAYER];			//玩家总成绩
	BYTE							m_cbLeftCardCount;						//扑克数目
	bool							m_bContiueCard;							//继续发牌
	BYTE							m_bcFirstPostCard;						//最新發牌點數
	LONGLONG						m_lExchangeGold[GAME_PLAYER];			//筹码
	LONGLONG						m_lUserTempScore[GAME_PLAYER];			//每局实际得分
	LONGLONG						m_lUserEveryTurnScore[GAME_PLAYER];		//每局玩家成绩
...
protected:
	...
	int								m_nRand;								//打枪次数
	int								m_nLucky;								//开LUCKY的几率
	LONGLONG						m_lStartStorage;						//起始库存
...
protected:
	...
	LONGLONG						m_lStorageMax[MAX_STORAGE_COUNT];		//库存封顶
	WORD							m_wStorageMul[MAX_STORAGE_COUNT];		//库存封顶后对应的输赢比例
	//机器人控制
protected:
