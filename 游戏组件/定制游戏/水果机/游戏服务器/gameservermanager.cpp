...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("FruitBattleAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("FruitBattleAndroid.dll")	//组件名字
#endif
//全局变量
...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("FruitBattle.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("FruitBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
{
	bool bReturn = m_DlgCustomRule.SaveCustomRule(pcbCustomRule,wCustonSize);
	return bReturn;
	/*//效验状态
...
HWND CGameServiceManager::CreateCustomRule(CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize)
{
	...
	if (hDllInstance == NULL) m_DlgCustomRule.DeleteAndroid();
