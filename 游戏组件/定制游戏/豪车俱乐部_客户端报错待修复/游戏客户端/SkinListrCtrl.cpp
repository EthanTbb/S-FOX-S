...
void CSkinHeaderCtrlEx::OnPaint() 
{
	...
	m_pngBack.DrawImage(&dc,0,0,ClientRect.Width(),ClientRect.Height(),268,4);
	//建立缓冲图
// 	CRect ClientRect;
// 	GetClientRect(&ClientRect);
// 	CBitmap BufferBmp;
...
CSkinHeaderCtrlEx::CSkinHeaderCtrlEx()
{
	...
	m_pngBack.LoadImage(AfxGetInstanceHandle(),TEXT("USER_BANKER_LIST"));
}
//////////////////////////////////////////////////////////////////////////
...
// 	if( bHighlight) 
// 	{ 
// 		pDC->SetBkColor(RGB(13,37,75));
// 		pDC->FillRect(rcBack, &CBrush(RGB(33,67,105))); 
// 	} 
// 	else 
// 	{ 
// 		//pDC->FillRect(rcBack, &CBrush(RGB(13,37,75))); 
// 	} 
	...
	{ 
		CPoint pt(0,lpDIS->rcItem.top);
		//m_ImageUserStatus.Draw(pDC,lvi.iImage,pt,ILD_TRANSPARENT);
		//写文本 
		CString szText; 
...
BOOL CSkinListCtrlEx::OnEraseBkgnd(CDC * pDC) 
{
	...
	m_pngBack.DrawImage(pDC,0,0,ClientRect.Width(),ClientRect.Height(),268,4);
...
INT CSkinListCtrlEx::SortItemData(LPARAM lParam1, LPARAM lParam2, WORD wColumnIndex, bool bAscendSort)
{
	...
	{
		int nData1=_ttoi(szBuffer1);
		int nData2=_ttoi(szBuffer2);
