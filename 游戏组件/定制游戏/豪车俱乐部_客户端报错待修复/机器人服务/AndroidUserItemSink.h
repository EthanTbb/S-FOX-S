...
protected:
	...
	//下庄变量
protected:
	LONGLONG						m_lRobotGiveUpWinMin;				//最小分数
	LONGLONG						m_lRobotGiveUpWinMax;				//最大分数
	LONGLONG						m_lBankerGetScore;					//庄家得分
