...
#define IDM_INVALIDATE        (WM_USER+502)           //刷新界面 
...
protected:
  ...
  bool              m_bOnDragCard;            //是否在拖牌中  090622a1 JJ
...
public:
  ...
  //设置间距
  void SetCardSpace(DWORD dwCardHSpace = 14, DWORD dwCardVSpace = 19, DWORD dwShootAltitude= 14);
  //基准位置
