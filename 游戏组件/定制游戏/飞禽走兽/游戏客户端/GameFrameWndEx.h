#ifndef GAME_FRAME_WND_HEAD_FILE1
#define GAME_FRAME_WND_HEAD_FILE1
...
//游戏窗口
class CGameFrameWndEx : public CFrameWnd, public IGameFrameWnd,public IFlashControlSink,public IClientPropertySink
{
  //状态变量
protected:
