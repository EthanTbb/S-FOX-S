...
struct tagCustomGeneral
{
  ...
  LONGLONG            lCompensateRadio;       //最大库存赔付比率
  LONGLONG            lBonus;             //彩金池

  // 区域几率
  LONGLONG            Area1Radio;           //兔子
  LONGLONG            Area2Radio;           //燕子
  LONGLONG            Area3Radio;           //鸽子
  LONGLONG            Area4Radio;           //孔雀
  LONGLONG            Area5Radio;           //老鹰
  LONGLONG            Area6Radio;           //狮子
  LONGLONG            Area7Radio;           //熊猫
  LONGLONG            Area8Radio;           //猴子
  LONGLONG            Area9Radio;           //鲨鱼
  LONGLONG            Area10Radio;          //通杀
  LONGLONG            Area11Radio;          //通赔
  LONGLONG            Area12Radio;          //黄金鲨鱼
