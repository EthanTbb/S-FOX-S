...
bool CDlgCustomRule::SaveCustomRule(LPBYTE pcbCustomRule, WORD wCustomSize)
{
  ...
  if(m_DlgCustomGeneral.m_CustomGeneral.lCompensateRadio<20||m_DlgCustomGeneral.m_CustomGeneral.lCompensateRadio>80)
  {
    AfxMessageBox(L"[最大库存赔付比率]输入范围为20-80");
    return false;
  }

  for(WORD index = IDC_RADIO_AREA1; index <= IDC_RADIO_AREA12; index++)
  {
    CString szData;
    m_DlgCustomGeneral.GetDlgItemText(index, szData);
    if(szData == TEXT(""))
    {
    ...
    if(_ttoi(szData) > 40 || _ttoi(szData) <= 0)
    {
      if(IDOK  == AfxMessageBox(TEXT("几率范围为1到40")))
      {
        return false;
      }
    }
  ...
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.lCompensateRadio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.lBonus);
  ...
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area1Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area2Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area3Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area4Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area5Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area6Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area7Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area8Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area9Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area10Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area11Radio);
  CheckDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.Area12Radio);
...
VOID CDlgCustomGeneral::DoDataExchange(CDataExchange* pDX)
{
  ...
  DDX_Text(pDX,IDC_EDIT_BONUS,m_CustomGeneral.lBonus);
  DDX_Text(pDX,IDC_EDIT_GENERAL_COMPENSATE,m_CustomGeneral.lCompensateRadio);
  ...
  DDX_Text(pDX,IDC_RADIO_AREA1,m_CustomGeneral.Area1Radio);
  DDX_Text(pDX,IDC_RADIO_AREA2,m_CustomGeneral.Area2Radio);
  DDX_Text(pDX,IDC_RADIO_AREA3,m_CustomGeneral.Area3Radio);
  DDX_Text(pDX,IDC_RADIO_AREA4,m_CustomGeneral.Area4Radio);
  DDX_Text(pDX,IDC_RADIO_AREA5,m_CustomGeneral.Area5Radio);
  DDX_Text(pDX,IDC_RADIO_AREA6,m_CustomGeneral.Area6Radio);
  DDX_Text(pDX,IDC_RADIO_AREA7,m_CustomGeneral.Area7Radio);
  DDX_Text(pDX,IDC_RADIO_AREA8,m_CustomGeneral.Area8Radio);
  DDX_Text(pDX,IDC_RADIO_AREA9,m_CustomGeneral.Area9Radio);
  DDX_Text(pDX,IDC_RADIO_AREA10,m_CustomGeneral.Area10Radio);
  DDX_Text(pDX,IDC_RADIO_AREA11,m_CustomGeneral.Area11Radio);
  DDX_Text(pDX,IDC_RADIO_AREA12,m_CustomGeneral.Area12Radio);
...
BOOL CDlgCustomGeneral::OnInitDialog()
{
  ...
  ((CEdit*)GetDlgItem(IDC_EDIT_BONUS))->LimitText(15);

  //限制输入
  for(WORD index = IDC_RADIO_AREA1; index <= IDC_RADIO_AREA12; index++)
  {
    ((CEdit*)GetDlgItem(index))->LimitText(2);
  }
