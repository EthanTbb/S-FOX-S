#ifndef UICOMMONCONTROLS_HEAD_FILE
#define UICOMMONCONTROLS_HEAD_FILE
#pragma once
...
public:
	...
	void SetStatusImage(LPCTSTR pStrImage);
...
public:
    ...
    UINT GetMaxChar();
	void SetOnlyNumber(bool bOnlyNumber=true);
	bool GetOnlyNumber();
