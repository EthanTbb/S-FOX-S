...
protected:
	...
	tagPersonalRoomOption *		m_pPersonalRoomOption;			//私人房配置
	tagPersonalRoomOptionRightAndFee * m_pCreateRoomRightAndFee;//权限与费用配置
	bool		m_bIsHasPersonalRoom;			//是否存在约战房
...
protected:
	...
	//选择改变
	VOID OnSelchangePersonalSqlType();
...
//私人房间配置
class MODULE_MANAGER_CLASS CDlgServerOptionItem5 : public CDlgServerOptionItem
{
	//函数定义
public:
	//构造函数
	CDlgServerOptionItem5();
	//析构函数
	virtual ~CDlgServerOptionItem5();
...
public:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedJoinGameRadio();
	afx_msg void OnBnClickedNotJoinRadio();
...
protected:
	...
	CDlgServerOptionItem5			m_ServerOptionItem5;				//设置步骤
...
public:
	...
	//设置私人房间参数
	void SetPersonalRoomParameter(tagPersonalRoomOption PersonalRoomOption, tagPersonalRoomOptionRightAndFee PersonalRoomOptionRightAndFee);
